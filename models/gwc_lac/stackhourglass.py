...
import math
from models.gwc_lac.submodule import convbn_3d, feature_extraction, DisparityRegression
from models.gwc_lac.deformable_refine import DeformableRefine, DeformableRefineF
#import loss_functions as lf
import matplotlib.pyplot as plt
from models.gwc_lac.refinement import StereoDRNetRefinement
...
class PSMNet(nn.Module):
    def __init__(self, maxdisp, loss_type, struct_fea_c, fuse_mode, affinity_settings, udc, refine):
    ...
    def forward(self, left, right, teaching=True):
        ...
        # else:
        if teaching:
            if self.loss_type == "2_feats":
                return [predr], refimg_fea, targetimg_fea
            elif self.loss_type == "gwc_vol":
                return [pred3], cost
